...
?>
    ...
    <section class="section">
        <div class="container">
            <div class="section-header">
                ...
                <h2>Apprenez les bons gestes en vidéo</h2>
            </div>
        ...
        <div class="container">
            ...
            <div class="pillar-grid">
                ...
                <div class="pillar-card">
                    ...
                    <p>Marche, natation, vélo : réduisent les risques cardiovasculaires.</p>
                </div>
                ...
                <div class="pillar-card">
                    ...
                    <p>Renforce votre immunité. Coupez les écrans 1h avant le coucher.</p>
                </div>

                <div class="pillar-card">
                    <div class="pillar-illustration">
                        <svg viewBox="0 0 120 120" width="90" height="90"><circle cx="60" cy="60" r="55" fill="#fef3c7" opacity=".5"/><circle cx="45" cy="60" r="16" fill="#f59e0b" opacity=".7"/><circle cx="75" cy="55" r="12" fill="#ef4444" opacity=".7"/><circle cx="65" cy="75" r="10" fill="#22c55e" opacity=".7"/><circle cx="50" cy="45" r="8" fill="#f97316" opacity=".6"/></svg>
                    </div>
                    <h3>Alimentation</h3>
                    <div class="pillar-stat">5 fruits <small>& légumes / jour</small></div>
                    <p>Fruits, légumes, céréales complètes. Limitez sel, sucre et graisses.</p>
                </div>
                ...
                <div class="pillar-card">
                    ...
                    <h3>Vaccination</h3>
                    <div class="pillar-stat">A jour <small>calendrier vaccinal</small></div>
                    <p>Grippe, tétanos, zona... Indispensable surtout après 65 ans.</p>
                </div>

                <div class="pillar-card">
                    <div class="pillar-illustration">
                        <svg viewBox="0 0 120 120" width="90" height="90"><circle cx="60" cy="60" r="55" fill="#e0f2fe" opacity=".5"/><rect x="35" y="20" width="50" height="65" rx="5" fill="#0284c7" opacity=".2"/><rect x="40" y="30" width="40" height="6" rx="2" fill="#0284c7" opacity=".5"/><rect x="40" y="42" width="30" height="4" rx="2" fill="#0284c7" opacity=".3"/><rect x="40" y="52" width="35" height="4" rx="2" fill="#0284c7" opacity=".3"/><circle cx="75" cy="80" r="18" fill="#0284c7" opacity=".8"/><path d="M68 80 L73 85 L83 75" stroke="#fff" stroke-width="3" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
                    </div>
                    <h3>Dépistages</h3>
                    <div class="pillar-stat">Réguliers <small>tension, glycémie</small></div>
                    <p>Détection précoce = meilleur pronostic. Consultez régulièrement.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <div class="section-header">
                <span class="section-tag">Tutoriels</span>
                <h2>Les bons gestes pas à pas</h2>
            </div>

            <div class="tuto-grid">
                <!-- Lavage des mains -->
                <div class="tuto-card tuto-blue">
                    <div class="tuto-header">
                        ...
                        <div>
                            ...
                            <span class="tuto-meta">6 étapes &middot; 30 secondes</span>
                        </div>
                    </div>
                    <ol class="tuto-steps">
                        <li><strong>Mouiller</strong> sous l'eau tiède</li>
                        <li><strong>Savonner</strong> paume contre paume</li>
                        <li><strong>Frotter</strong> les entre-doigts</li>
                        <li><strong>Dos</strong> de chaque main</li>
                        <li><strong>Pouces</strong> en rotation</li>
                        <li><strong>Rincer</strong> et sécher soigneusement</li>
                    </ol>
                </div>

                <!-- Glycémie -->
                <div class="tuto-card tuto-amber">
                    <div class="tuto-header">
                        <div class="tuto-icon">
                        ...
                        <div>
                            ...
                            <span class="tuto-meta">4 étapes &middot; Diabète</span>
                        </div>
                    </div>
                    <ol class="tuto-steps">
                        <li><strong>Laver</strong> les mains à l'eau chaude</li>
                        <li><strong>Insérer</strong> une bandelette neuve</li>
                        <li><strong>Piquer</strong> le côté du doigt</li>
                        <li><strong>Lire</strong> et noter (normal : 0,70 - 1,10 g/L)</li>
                    </ol>
                    <div class="tuto-alert">Consultez si &gt; 1,26 g/L à jeun ou &lt; 0,60 g/L</div>
                </div>

                <!-- Prévention chutes -->
                <div class="tuto-card tuto-green">
                    <div class="tuto-header">
                        <div class="tuto-icon">
                        ...
                        <div>
                            ...
                            <span class="tuto-meta">4 points clés &middot; Seniors</span>
                        </div>
                    </div>
                    <ol class="tuto-steps">
                        <li><strong>Éclairer</strong> couloirs et escaliers la nuit</li>
                        <li><strong>Retirer</strong> tapis glissants et câbles au sol</li>
                        <li><strong>Installer</strong> des barres d'appui (salle de bain, WC)</li>
                        <li><strong>Porter</strong> des chaussures antidérapantes</li>
                    </ol>
                    <div class="tuto-fact">Les chutes : 1ère cause d'accident domestique chez les +65 ans (9 300 décès/an en France).</div>
                </div>
            </div>
        </div>
    </section>
